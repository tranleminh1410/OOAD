        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppointmentType = table.Column<string>(type: "nvarchar(8)", maxLength: 8, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupMeetingUser", x => new { x.GroupMeetingId, x.ParticipantsUserId });
                    table.ForeignKey(
                        name: "FK_GroupMeetingUser_Appointments_GroupMeetingId",
                        column: x => x.GroupMeetingId,
                        principalTable: "Appointments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GroupMeetingUser_Users_ParticipantsUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GroupMeetingUser_ParticipantsUserId",
                table: "GroupMeetingUser",
